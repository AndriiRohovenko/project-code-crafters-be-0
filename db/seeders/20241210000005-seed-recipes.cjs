...
module.exports = {
  async up(queryInterface, Sequelize) {
    // Отримуємо ID категорій та областей
    ...
    const recipes = [
      ...
      },
      {
        ...
        description: "A hearty casserole with tender lamb and vegetables, topped with sliced potatoes.",
      ...
      },
      {
        ...
        thumb: "https://ftp.goit.study/img/so-yummy/preview/Teriyaki%20Chicken%20Casserole.jpg",
        time: "75",
        userId: users[0].id,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        thumb: "https://ftp.goit.study/img/so-yummy/preview/Honey%20Teriyaki%20Salmon.jpg",
        time: "25",
        userId: users[0].id,
        createdAt: now,
        updatedAt: now,
      ...
      },
      {
        ...
        description: "A traditional Jamaican dish made with callaloo leaves and a variety of spices. Served with rice and peas.",
        thumb: "https://ftp.goit.study/img/so-yummy/preview/Callaloo%20Jamaican%20Style.jpg",
        time: "30",
        userId: users[0].id,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        description: "A comforting American dish of beef brisket slow-cooked with root vegetables and herbs until tender and flavorful.",
        thumb: "https://ftp.goit.study/img/so-yummy/preview/Beef%20Brisket%20Pot%20Roast.jpg",
        time: "300",
        userId: users[0].id,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        description: "A popular Polish pastry, Rogaliki are crescent-shaped cookies made from a flaky, buttery dough and typically filled with jam, nuts, or poppy seeds.",
        thumb: "https://ftp.goit.study/img/so-yummy/preview/Rogaliki%20_Polish%20Croissant%20Cookies_.jpg",
        time: "35",
        userId: users[0].id,
        createdAt: now,
        updatedAt: now,
